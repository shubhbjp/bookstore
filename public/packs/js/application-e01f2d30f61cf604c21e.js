...
window.onload = function () {
  document.getElementById('add_new_book').onclick = function (evt) {
    changeTab(evt);
  };

  document.getElementById('add_new_author').onclick = function (evt) {
    changeTab(evt);
  };
};
...
/******/ });
//# sourceMappingURL=application-e01f2d30f61cf604c21e.js.map