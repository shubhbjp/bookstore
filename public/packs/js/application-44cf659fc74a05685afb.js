...
function changeTab(tabName) {
  document.getElementById("add_new_book").className = "insert-tab";
  document.getElementById("add_new_author").className = "insert-tab";

  if (tabName == 'book') {
    document.getElementById("add_new_book").className = "insert-tab-active";
  } else if (tabName == 'author') {
    document.getElementById("add_new_author").className = "insert-tab-active";
  }
}
...
/******/ });
//# sourceMappingURL=application-44cf659fc74a05685afb.js.map